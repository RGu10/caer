...
namespace zs_axi_bits {
    ...
    static const uint8_t BURST_VALUE_SHIFT = 50;
...
namespace axi_parameters {
    ...
    static const uint64_t AXI_TRANSFER_LENGTH_BYTES = 0x400; //1 KB - same value hardocded in zs2mm2s

    static const uint64_t AXI_TRANSFER_LENGTH_WORDS = axi_parameters::AXI_TRANSFER_LENGTH_BYTES / (axi_parameters::AXI_WIDTH / 8);

    static const uint64_t OPERATING_MODE_PARTIAL_SHIFTED = (uint64_t) ((uint64_t) 1) << (zs_axi_bits::BURST_VALUE_SHIFT + 1);

    static const uint64_t OPERATING_MODE_PARTIAL_SHIFTED_VALID = OPERATING_MODE_PARTIAL_SHIFTED
            | (uint64_t) 1 << zs_axi_bits::BURST_VALUE_SHIFT;

    static const uint64_t OPERATING_MODE_COMPLETE_SHIFTED_VALID = (uint64_t) 1 << zs_axi_bits::BURST_VALUE_SHIFT;
